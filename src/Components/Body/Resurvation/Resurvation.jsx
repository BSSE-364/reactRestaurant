                    ...
                    <Grid container spacing={1} >
                        <Grid item xs={12} sm={12} md={12} lg={12} style={{ position: "relative", display: "flex", justifyContent: "center" }}>
                            ...
                            <Box className={classes.textDiv}>
                                <MotionTypography variant="h4" gutterBottom className={classes.text1}
                                    initial={{ y: -150, opacity: 0 }}
                                    animate={{ y: 0, opacity: 1 }}
                                    transition={{ delay: 1.2, duration: 1.2, type: "spring", stiffness: 180 }}
                                >
                                    Book A Table
                                </MotionTypography>
                                <MotionBox p={12} shadow="lg" borderWidth="1px"
                                    ...
                                    animate={{ y: 0, opacity: 1 }}
                                    transition={{ delay: 2, duration: 1.2, type: "spring", stiffness: 180 }}
                                >
